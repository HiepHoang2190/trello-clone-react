  ...
  return (
    <div className="column">
      <header className="column-drag-handle">
        <div className="column-title">
          <Form.Control
            ...
            value={columnTitle}
            onChange={handleCoumnTitleChange}
            onBlur={handleCoumnTitleBlur}
      ...
      <ConfirmModal
        ...
        title="Remove column"
        content={`Are you sure you to remove <strong>${column.title} </strong>. <br/> All related cards will also be removed!`}
      />
    </div>
  )
}
